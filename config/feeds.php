...
return [
    ...
    Competition::SixNations->value => 'https://cdn.soticservers.net/tools/wordpress/ical/calendar.php?CompId=4360&source=sfms&project=sixnations&TeamId={{team}}',
    ...
    Competition::WomensSixNations->value => 'https://cdn.soticservers.net/tools/wordpress/ical/calendar.php?CompId=4392&source=sfms&project=sixnations&TeamId={{team}}',
